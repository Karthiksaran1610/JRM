...
import { LuShip, LuCheck, LuPackage } from "react-icons/lu";
    ...
    return (
      ...
      {/* <TimelineRoot size="sm" variant="outline">
        <TimelineItem>
          ...
          <TimelineConnector />
          <TimelineContent flex="1">
            <TimelineTitle>Placed Order Lorem ipsum dolor sit amet consectetur adipisicing elit. Est dolores doloremque vero reprehenderit placeat cumque repellat ea ipsa quia laborum error voluptate ullam maxime odio, id sunt eaque voluptas assumenda.</TimelineTitle>
          </TimelineContent>
        </TimelineItem>
  
        <TimelineItem>
          <TimelineContent flex="1" alignItems="flex-end">
            <TimelineTitle>Prepared Orde Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis quibusdam hic impedit fugit incidunt mollitia iure aliquid! Culpa neque numquam quibusdam ullam dolorem quidem, sequi ex magni omnis vitae.</TimelineTitle>
          </TimelineContent>
          <TimelineConnector />
          <TimelineContent flex="1" />
        </TimelineItem>
